...
static ssize_t dev_write(struct file *filep, const char *buffer, size_t len, loff_t *offset){
  ...
  if(len + char_dev_size_of_message > SIZE)
    len = SIZE - char_dev_size_of_message;

  memcpy(char_dev_message + char_dev_size_of_message, buffer, len);

  char_dev_size_of_message = char_dev_size_of_message + len;                 // store the length of the stored message
